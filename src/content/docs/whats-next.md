---
title: What's next
description: v1.1 → v1.10.3 all shipped 2026-06-03. Next milestones land here when planned.
---

## TL;DR

**The entire v1.6 → v1.10.3 slate shipped on 2026-06-03**, plus v1.1 → v1.5 earlier the same day. Eighteen base + three patch milestones, all measured.

- **v1.6 Voice cloning ship-it** — XTTS-v2 sidecar live; real Gabriel voice; 5 install blockers fixed
...
- **v1.10 Menubar UI** — SwiftUI status item + queue + Skip/Clear + voice picker; ducking + Linux GTK deferred to v1.10.1
- **v1.10.2 History + pause/resume + floating player** — persistent timeline + always-on-top widget
- **v1.10.3 Guided voice clone UI** — one-button Pt-BR clone window in the menubar app; `--quiet` machine-parseable contract on `voice clone`
