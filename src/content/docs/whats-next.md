---
title: What's next
description: Next versions of agent-tts (v1.6, v1.7, v1.9, v1.10) — voice cloning ship-it, streaming text input, web playground, and menubar UI. v1.8 (SSML & prosody) shipped 2026-06-03.
---

## TL;DR

The whole **v1.1 → v1.5** marketing slate shipped on **2026-06-03**, then v1.8 (SSML & prosody) closed the inflection gap. The remaining slate (**v1.6, v1.7, v1.9, v1.10**) takes the runtime and points it at four distinct audiences: people who want their cloned voice to actually work, people who want the agent to start speaking before it finishes thinking, people who want to try every voice in a browser, and people who want a face on the daemon.
